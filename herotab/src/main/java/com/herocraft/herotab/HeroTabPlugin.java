...
@Plugin(
        ...
        name = "HeroTab",
        version = "3.0.0",
        description = "Plugin Velocity pour HeroCraft — tab list unifié, fluide et personnalisable sur tout le réseau (header/footer animés, tri configurable, mode safe pour les skins, intégration MySQL GradePlugin & FactionPlugin, tag de faction dans le tab et le chat limité au serveur Factions, JAR shaded avec dépendances embarquées). Velocity 3.3.0+, Java 17+.",
        authors = {"HeroCraft"}
)
